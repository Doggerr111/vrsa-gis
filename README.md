...
VRSA — это геоинформационная система, разработанная на C++/Qt с использованием библиотек GDAL и GEOS. Поддерживает векторные и растровые данные, пространственный анализ, тайловые сервисы и работу с базами данных.
